...
contract Domains is ERC721URIStorage {
  ...
  string public tld;
  string public dym; // Yeni dym değişkeni eklenir
  ...
  function register(string calldata name) public payable {
    ...
    require(msg.value >= _price, "Not enough Matic paid");
		...
		// Combine the name passed into the function with the TLD and dym
    string memory _name = string(abi.encodePacked(name, ".", tld, ".", dym));
